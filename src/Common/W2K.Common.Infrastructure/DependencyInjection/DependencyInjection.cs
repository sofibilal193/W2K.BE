...
using W2K.Common.Infrastructure.Crypto;
using W2K.Common.Infrastructure.AppInsights;
using W2K.Common.Application.ApiServices;
using W2K.Common.Infrastructure.ApiServices;
using W2K.Common.Infrastructure.Logging;
using Polly;
using W2K.Common.Infrastructure.AppConfig;
using SendGrid;
using W2K.Common.Application.Messaging;
using W2K.Common.Infrastructure.Messaging;
using Twilio.Clients;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Diagnostics.HealthChecks;
using W2K.Common.Application.Storage;
using W2K.Common.Infrastructure.Storage;
using W2K.Common.Infrastructure.AzureAd;
using Microsoft.Graph;
using W2K.Common.Application.AzureAd;
using W2K.Common.Application.Session;
using W2K.Common.Infrastructure.Session;
using W2K.Common.Application.Auth;
using W2K.Common.Infrastructure.Auth;
using StackExchange.Redis;

namespace W2K.Common.Infrastructure.DependencyInjection;
